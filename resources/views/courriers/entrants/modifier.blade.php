                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="card custom-card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <form action="{{route('courriers.entrants.update')}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="col-md-12 col-lg-12 col-xl-12">
                                        <div class="row">
                                            <div class="form-group col-4">
                                                ...
                                                <input class="form-control"  type="number" name="reference" value="{{$courrier_entrant->reference}}">
                                                <input class="form-control"  type="hidden" name="courrier_id" value="{{$courrier_entrant->id}}">
                                                @error('reference')
                                            ...
                                            <div class="form-group col-4">
                                                <label>Date d'arriver de courrier <span class="text-danger">*</span></label>
                                                <input class="form-control" id="dateMask" placeholder="MM/DD/YYYY"
                                                    type="text" name="date_arriver" value="{{$courrier_entrant->date_arriver}}">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="form-group col-4">
                                                ...
                                                <select class="form-control select2-show-search" name="client">
                                                    ...
                                                    {{ $data_client->id == $courrier_entrant->client_id ? 'selected' : '' }}>
                                            ...
                                            <div class="form-group col-4">
                                                ...
                                                <select class="form-control select2-show-search" name="type_courrier">
                                                    ...
                                                    {{ $data_type_courrier->id == $courrier_entrant->type_courrier_id ? 'selected' : '' }}>
                                            ...
                                            <div class="form-group col-4">
                                                ...
                                                <select class="form-control select2-show-search" name="service_traitant">
                                                   @foreach($service as $data_service)
                                                    ...
                                                    {{ $data_service->id == $courrier_entrant->service_traitant_id ? 'selected' : '' }}>
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                               <label>Objet <span class="text-danger">*</span></label>
                                                ...
                                                <textarea class="form-control" name="objet" rows="4" placeholder="Objet">{{$courrier_entrant->objet}}</textarea>
                                                @error('objet')
                                                <div class="error text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>

                        ...
                        <div class="card custom-card overflow-hidden">
                            <div class="card-body">
                                <div class="card-header border-bottom-0 p-0">
                                    <h6 class="card-title mb-1">Liste Des Courriers Entrants</h6><br>
                                </div>
                                    ...
                                    <table id="exportexample" class="table table-bordered key-buttons text-nowrap w-100">
                                        <thead>
                                            <tr>
                                                <th>N° Référence</th>
                                                <th>Date Courrier</th>
                                                <th>Date d'arriver de courrier</th>
                                                <th>Client</th>
                                                <th>Type Courrier</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$entrant->date_arriver}}</td>
                                                <td>{{optional($entrant->Client)->nom_complet}}</td>
                                                <td>{{optional($entrant->Type_courrier)->type}}</td>
                                                <td>{{optional($entrant->Service_traitant)->service}}</td>
                                              
                                                <td>
                                                    <a href="{{route('courriers.entrants.consulter', $entrant->id)}}" class="text-primary a-action" data-bs-toggle="tooltip" title="Consultation"><i class="ti-eye"></i></a>
                                                    <a href="{{route('courriers.entrants.show_update', $entrant->id)}}" class="text-success a-action" data-bs-toggle="tooltip" title="Modification"><i class="ti-pencil-alt"></i></a>
                                                    @can('access_admin')
                                                    <a href="{{route('courriers.entrants.supprimer', $entrant->id)}}" class="text-danger a-action"data-bs-toggle="tooltip" title="Suppression"><i class="ti-trash"></i></a></a>
                                                    @endcan
                                                    <a href="{{route('courriers.entrants.archiver', $entrant->id)}}" class="text-warning a-action"data-bs-toggle="tooltip" title="Archivage"><i class="ti-bookmark"></i></a></a>
                                               </td>
                                            </tr>
                                            @endforeach

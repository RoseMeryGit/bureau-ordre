                                    ...
                                    <div class="col-md-12 col-lg-12 col-xl-12">
                                        <div class="row">
                                            <div class="form-group col-4">
                                                ...
                                                <input class="form-control"  type="number" name="reference">
                                                @error('reference')
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                               <label>Objet <span class="text-danger">*</span></label>
                                                ...
                                                <textarea class="form-control" name="objet" rows="4" placeholder="Objet"></textarea>
                                                @error('objet')
                                                <div class="error text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>

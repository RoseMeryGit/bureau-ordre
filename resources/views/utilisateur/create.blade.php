                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="card custom-card">
                            <div class="card-body">
                                ...
                                <div class="row">
                  <form  action="{{route('add.utilisateur')}}" method="POST"  enctype="multipart/form-data">
                    @csrf 
                        <div class="row ">
                            <label for="user">Type utilisateur</label>
                          ...
                          <div class="form-group col-4">
                                <label>Nom</label>
                                <input type="text" id="nom" name="nom" class="form-control" aria-describedby="emailHelp" placeholder="Nom">
                                @error('nom')
